...
int CRichEditCtrl::GetLine(int nIndex, __out LPTSTR lpszBuffer) const
{
...
int CRichEditCtrl::GetLine(int nIndex, __out_ecount(nMaxLength) LPTSTR lpszBuffer, int nMaxLength) const
{
	ASSERT(::IsWindow(m_hWnd));
