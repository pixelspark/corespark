...
int AFXAPI AfxLoadString(UINT nID, __out_ecount(nMaxBuf) LPWSTR lpszBuf, UINT nMaxBuf)
{
	...
	Checked::memcpy_s(lpszBuf, nMaxBuf-1, pImage->achString, nCharsToCopy*sizeof(WCHAR));
