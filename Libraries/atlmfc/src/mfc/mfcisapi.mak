...
!if "$(CL_MODEL)" == ""
!error PLATFORM must be one of INTEL, MIPS, ALPHA, PPC, IA64, AMD64
!endif
...
#
!if "$(OBJ)" == ""
D=$(PLATFORM)\$$$(TYPE)$(MODEL)$(DEBUGSUF)    # subdirectory specific to variant
!else
...
CVOPTS=/Z7
!else
CVOPTS=/Zi /Fd..\..\lib\$(PLATFORM)\$(GOAL).pdb
!endif
!endif
...
#
!if "$(PLATFORM)" == "INTEL"
CL_OPT=/W4 /WX /Zl /EHsc $(DEBOPTS) $(CVOPTS) $(TARGOPTS)
!endif
...
!if "$(PLATFORM)" == "IA64"
!if "$(DEBUG)" != "0"
INETASM=$(D)\inetcald.obj
!else
INETASM=$(D)\inetcaln.obj
!endif
!endif
...
$(INETASM) : ia64\inetcal_.s
	ias $(ASMOPT) -o $@ ia64\inetcal_.s
...
$(INETASM) : amd64\inetcal_.s
	ml64 $(ASMOPT) -c -Fo$@ amd64\inetcal_.s
