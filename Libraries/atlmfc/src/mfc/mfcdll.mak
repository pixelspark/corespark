...
# if LIBNAME=="mfc80" then static lib is named as in afx.h mfcs80.lib.
...
LFLAGS=$(LFLAGS) /version:8.0
!if "$(UNICODE)" == "1"
LFLAGS=$(LFLAGS) /base:0x782E0000
!else
LFLAGS=$(LFLAGS) /base:0x781D0000
!endif

!if "$(PLATFORM)" == "IA64" || "$(PLATFORM)" == "AMD64"
LIBS=$(CRTDLL) kernel32.lib gdi32.lib msimg32.lib user32.lib uuid.lib htmlhelp.lib shlwapi.lib $(PROFLIB)
!else
...
# Always compile /Zi (generate PDB) for mfcs80[u][d].lib, since we never get a chance to have the
