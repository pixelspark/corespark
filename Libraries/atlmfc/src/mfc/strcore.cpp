...
LPWSTR AFXAPI AfxA2WHelper(__out_ecount(nChars) LPWSTR lpw, LPCSTR lpa, int nChars)
{
	return AtlA2WHelper(lpw, lpa, nChars,CP_ACP);
}

LPSTR AFXAPI AfxW2AHelper(__out_ecount(nChars) LPSTR lpa, LPCWSTR lpw, int nChars)
{
