...
//
void COleClientItem::GetItemName(__out __out_z LPTSTR lpszItemName) const
{
	ASSERT_VALID(this);
...
void COleClientItem::GetItemName(__out_ecount(cchItemName) __out_z LPTSTR lpszItemName, UINT cchItemName ) const
{
	ASSERT_VALID(this);
	ASSERT(lpszItemName != NULL);
...
//
static void AfxGetIconInfo(LPCTSTR lpszRegInfo, __out LPTSTR lpszImagePath,
	UINT& nIndex)
{
