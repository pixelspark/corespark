...
#define AFX_WNDCLASS(s) \
	_T("Afx") _T(s) _T("80") _STATIC_SUFFIX _UNICODE_SUFFIX _DEBUG_SUFFIX
...
UINT AFXAPI AfxGetFileName(LPCTSTR lpszPathName, __out_ecount_opt(nMax) LPTSTR lpszTitle, UINT nMax);
...
BOOL AFXAPI AfxResolveShortcut(CWnd* pWnd, LPCTSTR pszShortcutFile,
	__out_ecount(cchPath) LPTSTR pszPath, int cchPath);
