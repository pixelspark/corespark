...
BOOL CDaoException::GetErrorMessage(__out_ecount(nMaxError) LPTSTR lpszError, UINT nMaxError,
...
void AFX_CDECL CDaoRecordset::StripBrackets(LPCTSTR lpszSrc, __out LPTSTR lpszDest)
{
	while (*lpszSrc != '\0')
	{
		// Ignore all brackets
