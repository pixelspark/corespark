...
BOOL CException::GetErrorMessage(__out LPTSTR lpszError, UINT nMaxError,
...
BOOL CSimpleException::GetErrorMessage(__out_ecount(nMaxError) LPTSTR lpszError, UINT nMaxError,
