...
// object are released.
extern "C" void MFCM80ReleaseManagedReferences(IUnknown* pIUnknown)
{
...
// This is left in simply because it would be a breaking change
// to remove it at this point, and we aren't allowed any more
// breaking changes. So we'll leave this little harmless thing in
// for now.
extern "C" void DummyIncludeMFC80MDll()
{
}
...
[assembly: AssemblyTitle("mfcm80")];
[assembly: AssemblyDescription("MFC 8.0 Managed Interoperability")];
