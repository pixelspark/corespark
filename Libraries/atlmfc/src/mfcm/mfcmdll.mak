...
DLL=2
MANAGED=1
TARGDEFS=/D_AFXEXT /DBUILD_MFCM80
...
!if "$(UNICODE)" == "1"
LFLAGS=$(LFLAGS) /base:0x7C650000
!else
LFLAGS=$(LFLAGS) /base:0x7C550000
!endif
...
$(DN)\mfcm.obj: mfcm.cpp
	cl $(CPPFLAGS_NATIVE) /clr- /Y- /Fo$(DN)\ /c mfcm.cpp
