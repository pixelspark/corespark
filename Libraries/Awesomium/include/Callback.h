/*
	...
	AJS15822: Modified for use with Awesomium; trimmed templates down to 2-argument delegate.
*/
...
#undef FASTDELEGATE_USESTATICFUNCTIONHACK
	...
	typedef Impl::fastdelegate::FastDelegate2<WebView*, const JSArguments&, void> Callback;
}
#endif
