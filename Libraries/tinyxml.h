...
*/
class DLLEXPORT TiXmlNode : public TiXmlBase
{
	friend class TiXmlDocument;
	friend class TiXmlElement;
...
*/
class DLLEXPORT TiXmlAttribute : public TiXmlBase
{
...
*/
class DLLEXPORT TiXmlElement : public TiXmlNode
{
public:
...
/**	An XML comment.
*/
class DLLEXPORT TiXmlComment : public TiXmlNode
{
public:
...
*/
class DLLEXPORT TiXmlText : public TiXmlNode
{
	friend class TiXmlElement;
public:
	/// Constructor.
...
*/
class DLLEXPORT TiXmlDeclaration : public TiXmlNode
{
public:
...
*/
class DLLEXPORT TiXmlUnknown : public TiXmlNode
{
public:
...
*/
class DLLEXPORT TiXmlDocument : public TiXmlNode
{
public:
